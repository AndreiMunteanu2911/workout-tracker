...
export default function Navbar() {
    ...
    return (
        <>
            {/* Sidebar for desktop*/}
            <nav className="hidden md:flex w-64 sticky top-0 h-screen p-6 flex-col bg-[var(--primary-700)] text-white z-20">
            ...
            <nav className="fixed bottom-0 left-0 right-0 md:hidden bg-[var(--primary-700)] text-white z-20 border-t border-[var(--primary-800)]">
